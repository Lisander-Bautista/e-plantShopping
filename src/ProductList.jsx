  ...
  const styleLink = {
    ...
    return (
      <div>
        <nav style={styleNav}>
          <div>
            <a href="/" onClick={handleHomeClick} style={styleLink}>
              Paradise Nursery
            </a>
          </div>
  
          <div style={styleMenu}>
            <span onClick={handlePlantsClick} style={styleLink}>
              Plants
            </span>
  
            <span onClick={handleCartClick} style={styleLink}>
              🛒
              {totalQuantity > 0 && (
        ...
        <div className="product-grid">
          {plantsArray.map((section, i) => (
            <section key={i}>
              <h2>{section.category}</h2>
              <div className="product-list">
                {section.plants.map((plant, idx) => {
                  // aquí se define isInCart antes de usarlo
                  ...
                  return (
                    <div className="product-card" key={idx}>
                      ...
                      >
                        {isInCart ? 'Añadido al carrito' : 'Add to Cart'}
                      </button>
                    </div>
                  )
                })}
